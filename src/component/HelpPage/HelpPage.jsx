  ...
  return (
    <section className=" help">
      <div className="help__wrap">
        ...
        <h2>Skip the line, submit your question </h2>
        <p>
          Complete our easy and interactive form in just 3 easy steps to
          generate a ticket with our team and we will get back to you as soon as
          possible with an answer either through email or phone, whatever works
          best for you
        </p>
        ...
        <div className="help__text--box">
          <h2>Want to speak to a representative? </h2>
          <h3>Give us a call at the numbers below: </h3>
          <p>
